...
import Slide3Size from './slide-3-size.vue'
import Slide4Screen from './slide-4-screen.vue'
import Slide5Resolution from './slide-5-resolution.vue'
import Slide6Params from './slide-6-params.vue'
import Slide7Brands from './slide-7-brands.vue'
import Slide8Budget from './slide-8-budget.vue'
import Slide9Avoid from './slide-9-avoid.vue'
import Slide10Summary from './slide-10-summary.vue'
import Slide11End from './slide-11-end.vue'
...
const presentationContext = createPresentationContext({
  ...
  contextKey: 'tv-buying-guide',
  persist: true
})

providePresentationContext(presentationContext)

const title = computed(() => '电视选购指南')
