...
import Slide2Intro from './slide-2-intro.vue'
import Slide3CoreIdea from './slide-3-core-idea.vue'
import Slide4Position from './slide-4-position.vue'
import Slide5Principle from './slide-5-principle.vue'
import Slide6Suction from './slide-6-suction.vue'
import Slide7Antiwrap from './slide-7-antiwrap.vue'
import Slide8Deadcorner from './slide-8-deadcorner.vue'
import Slide9Drying from './slide-9-drying.vue'
import Slide10Battery from './slide-10-battery.vue'
import Slide11Assist from './slide-11-assist.vue'
import Slide12Traps from './slide-12-traps.vue'
import Slide13Summary from './slide-13-summary.vue'
import Slide14End from './slide-14-end.vue'
...
const presentationContext = createPresentationContext({
  ...
  contextKey: 'xidiji-select',
  persist: true
})

providePresentationContext(presentationContext)

const title = computed(() => '洗地机选购核心参数')
