...
import XidijiProductCard from '../../shared/product-card/cards/XidijiProductCard.vue'
...
<template>
  <div class="product-showcase-page">
    ...
    <div class="content-wrapper">
      ...
      >
        <XidijiProductCard :product="currentProduct" :direction="slideDirection" />
      </div>
    </div>
