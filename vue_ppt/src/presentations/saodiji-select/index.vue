...
import Slide4Navigation from './slide-4-navigation.vue'
import Slide5AiAvoidance from './slide-5-ai-avoidance.vue'
import Slide6EdgeCoverage from './slide-6-edge-coverage.vue'
import Slide7MechanicalArm from './slide-7-mechanical-arm.vue'
import Slide8AntiWrap from './slide-8-anti-wrap.vue'
import Slide9BaseStation from './slide-9-base-station.vue'
import Slide10BudgetRange from './slide-10-budget-range.vue'
import Slide11Summary from './slide-11-summary.vue'
import Slide12End from './slide-12-end.vue'
...
const presentationContext = createPresentationContext({
  ...
  contextKey: 'saodiji-select',
  persist: true
})

providePresentationContext(presentationContext)

const title = computed(() => '扫地机器人选购核心参数')
