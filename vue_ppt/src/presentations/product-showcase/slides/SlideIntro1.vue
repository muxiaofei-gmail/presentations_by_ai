...
import { getPriceRangeInfo } from '@/router/routes/product-showcase'
...
const priceInfo = computed(() => {
  return getPriceRangeInfo(props.productType as any, props.priceRange)
})
...
<template>
  <section class="slide-shell">
    <div class="title-block">
      <p class="price-tag">{{ priceInfo?.label || '' }}</p>
      <h1 class="title">
        <span class="title-normal">{{ typeName }}</span>
        <span class="title-gradient">怎么选？</span>
      </h1>
      <p class="subtitle">大家好，我是胡侃</p>
    </div>
  </section>
</template>
