...
import Slide3Screen from './slide-3-screen.vue'
import Slide4Quality from './slide-4-quality.vue'
import Slide5Chip from './slide-5-chip.vue'
import Slide6Traps from './slide-6-traps.vue'
import Slide7Summary from './slide-7-summary.vue'
import Slide8End from './slide-8-end.vue'
...
const presentationContext = createPresentationContext({
  ...
  contextKey: 'tv-select',
  persist: true
})

providePresentationContext(presentationContext)

const title = computed(() => '电视选购核心参数')
